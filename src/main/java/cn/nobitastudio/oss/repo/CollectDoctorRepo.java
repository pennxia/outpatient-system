...
public interface CollectDoctorRepo extends CrudRepository<CollectDoctor, Integer>, JpaSpecificationExecutor {
    ...
    @Query(value = "select dt.id as doctor_id,dt.name as doctor_name,dt.specialty as doctor_specialty,dt.sub_major as sub_major,dt.introduction as doctor_introduction,dt.level as doctor_level,dt.department_id as doctor_department_id," +
            "dp.* " +
